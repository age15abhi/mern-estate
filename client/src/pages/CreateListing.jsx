...
function CreateListing() {
  ...
  // here is the store file function
  ...
  // here the code to remove the image from the list
  ...
  // here is the function to handle to input change values
  ...
  // here is the code for submit the form
